...
/// <summary>
/// Extract Dependencies , Moq , verify , verifyNoOthercall
/// </summary>
public class EmailService_Tests 
{
    private readonly SampleProject.EmailService _service;
    ...
    {
        //Act
        await _service.SendAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), body);
